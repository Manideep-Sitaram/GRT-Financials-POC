...
def load_documents_initially(pdf_doc):
    ...
    ("Company Overview", "What are the revenue generating product lines and how they individually performed in 2023. Please provide results in a tabular format."),
    ...
    ("Profit & Loss", "Provide a table of all profit & loss statement of current year starting with sales and ending with net income amd the previous year details for the same items. Add another column showing y-o-y change in percent"),
